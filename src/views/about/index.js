...
export function About() {
  return (
    <div>
      ...
      <section>
        <p>
          Hi - I’m <a href="https://azzolini.io">Andre Azzolini</a>, and I built pubgheatmap.net as
          an open source app using GraphQL, React, and canvas. Iterating on this app has been a lot
          of fun, and I am actively adding more features. A current
          <a href="https://github.com/orgs/pubgsh/projects/1">roadmap is available</a>, and I’m
          happy to consider suggestions, pull requests, and bug reports on GitHub. The two
          repositories can be found here:
        </p>

        <ul style={{ listStyleType: "none" }}>
          <li>
            <a href="https://github.com/pubgsh/api">pubgsh/api</a>
          </li>
          <li>
            <a href="https://github.com/pubgsh/client">pubgsh/client</a>
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          me on <a href="https://www.patreon.com/apazzolini">Patreon</a>. pubgheatmap.net will
          always be free to use - donations help pay for server costs and keep me motivated to work
          on it. As a token of my appreciation, you’ll get a faster refresh time for your username.
        </p>
      </section>
